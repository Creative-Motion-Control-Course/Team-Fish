...
We aim to continue working to provide support for computer and plotter aided embossing, further developing our current framework. 
...
There are multiple directions we might take in order to improve the plotter. Here are some primary areas for improvement, with proposed solutions under each. 
...
3. Real-time z-axis adjustment from the user -- potentiometer ? 
